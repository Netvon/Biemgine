...
namespace spacebiem
{
    ...
    void PlanetFactory::create(const string& type, int pX, int pY, int width, int height, std::shared_ptr<EntityManager> entityManager, ResourceFactory resourceFactory , NameGenerator nameGenerator, map<string, float> atmosphereM, map<string, int> scoreBonus)
    {
        if (type == "moon") {
            ...
            resourceFactory.createPlanetResources(pX + (width / 2), pY + (height / 2), height / 2, "moon", entityManager);
        }
        else if (type == "earth") {
            ...
            resourceFactory.createPlanetResources(pX + (width / 2), pY + (height / 2), height / 2, "earth", entityManager);
        }
        else if (type == "sand") {
            ...
            resourceFactory.createPlanetResources(pX + (width / 2), pY + (height / 2), height / 2, "sand", entityManager);
        }
        else if (type == "toxic") {
            ...
            resourceFactory.createPlanetResources(pX + (width / 2), pY + (height / 2), height / 2, "toxic", entityManager);
        }
    }
}
