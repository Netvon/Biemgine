...
namespace spacebiem
{
    ButtonUIEntity::ButtonUIEntity(float x, float y, Color color, float w, float h, const string& pText, std::function<void(const StateManager*)> onClick)
    {
        ...
        addComponent("ui", new UIComponent({ w, h }, onClick));
